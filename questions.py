    ...
    questions = {
        ...
        "3": [
            ...
            {"question": "2. Who holds the record for the most career home runs in Major League Baseball (MLB)?",
             "answer": "babe ruth",
             "hint": "This record was set by a player known as The Sultan of Swat and is a significant milestone in baseball history.",
             "difficulty": "hard"},
        ],
        "4": [
            ...
            {"question": "1. Which river is the primary source of water for the city of Cairo, Egypt?",
             "answer": "nile river",
             "hint": "This river is one of the longest in the world and flows northward through northeastern Africa.",
             "difficulty": "medium"},

            {"question": "2. Which river is the longest in South America?",
             "answer": "amazon river",
             "hint": "This river flows through the Amazon Rainforest and is often confused with another long river in Africa.",
             "difficulty": "medium"},
            ...
            {"question": "4. Which country has the most time zones?",
             "answer": "russia",
             "hint": "This country spans across the entire width of Eurasia, making it the largest country by land area.",
             "difficulty": "hard"},
        ],
        "5": [
